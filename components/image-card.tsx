...
const ImageCard = ({ cssClasses, title, buttonText, image, flip }: Props) => {
  const [cardMove, setCardMove] = useState(false);

  return (
    <section
      className={classNames(
        `grid gap-10 grid-rows-3 ${image} bg-cover h-[300px] phone:h-[325px] tablet:h-[425px] tabletLarge:h-[550px] desktopSmall:h-[425px] desktop:h-[550px] place-items-start ${cssClasses}`,
        {
